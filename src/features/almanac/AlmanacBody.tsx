...
export function AlmanacBody({ roles, autoFocusSearch = false }: AlmanacBodyProps) {
  ...
  if (roles.length === 0) {
    return (
      <p className="behavior-help" style={{ padding: "16px 18px" }}>
        No script loaded — character reference unavailable.
      </p>
    );
  }
