...
export const TRAVELERS: RoleDef[] = [
  ...
  { id: "bountyhuntertraveller", name: "Bounty Hunter (Traveler)", type: "traveler", edition: "experimental",
    ability: "Each night, choose an alive player: if good, you learn their character.",
    flavor: '"Coin first. Conversation second."' },
  { id: "deviant_t", name: "Deviant (Traveler)", type: "traveler", edition: "experimental",
    ability: "If you were funny today, you cannot die by exile.",
    flavor: '"They can\'t hang a punchline."' },
